  ...
  context "authenticated and authorized users" do
    ...
    describe "POST create" do
      context "with valid attributes" do
        before do
          @new_user = build(:user)
          post :create, params: { user: { name: @new_user.name, email: @new_user.email, password: @new_user.password, role: "admin" } }
        end
      ...
      context "with invalid attributes" do
        before do
          post :create, params: { user: { name: "", email: "bademail@", password: "short" } }
        end
